...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSLog(@"beginning of application:didFinishLaunch...");
    ...
    //TODO life cycle debugging
    NSLog(@"end of application:didFinishLaunch...");
...
- (void)applicationWillResignActive:(UIApplication *)application
{
    ...
    [_viewController saveData];

    //TODO life cycle debugging
    NSLog(@"end of applicationWillResignActive");
}
...
- (void)applicationDidEnterBackground:(UIApplication *)application
{
    ...
    //TODO life cycle debugging
    NSLog(@"end of applicationDidEnterBackground");
...
//    [_viewController loadData];
    ...
    //TODO life cycle debugging
    NSLog(@"end of WillEnterForeground");
}
...
- (void)applicationWillTerminate:(UIApplication *)application
{
    [_viewController saveData];
    //TODO life cycle debugging
    NSLog(@"end of applicationWillTerminate");
    /*
